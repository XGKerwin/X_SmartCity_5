 ...
 * date   : 2021/2/5  15:53
 */
public class Fuwu_tcc_lishi_adapter extends RecyclerView.Adapter<Fuwu_tcc_lishi_adapter.ViewHolder> {
    private List<GetParkingHistory> getParkingHistories;

    public Fuwu_tcc_lishi_adapter(List<GetParkingHistory> getParkingHistories) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_lishi, parent, false);
