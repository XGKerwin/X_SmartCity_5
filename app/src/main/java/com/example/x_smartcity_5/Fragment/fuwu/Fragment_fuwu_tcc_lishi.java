...
import com.example.x_smartcity_5.adapter.Fuwu_tcc_lishi_adapter;
import com.example.x_smartcity_5.bean.GetParkingHistory;
 ...
 * date   : 2021/2/5  15:49
 */
public class Fragment_fuwu_tcc_lishi extends Fragment {
    ...
    private Fuwu_tcc_lishi_adapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_tcc_lishi, container, false);
        initView(view);
        title.setText("停车历史查询");
        ...
        new OKHttpTo().setUrl("getParkingHistory")
                .setOkHttpLo(new OkHttpLo() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        ...
                        adapter = new Fuwu_tcc_lishi_adapter(getParkingHistories);
        ...
        new OKHttpTo()
                ...
                .setOkHttpLo(new OkHttpLo() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        getParkingHistories.addAll(new Gson().fromJson(jsonObject.optJSONArray("ROWS_DETAIL").toString(),
                                new TypeToken<List<GetParkingHistory>>(){}.getType()));
                        Log.d("fffffffffff", "onResponse: "+getParkingHistories.size());
